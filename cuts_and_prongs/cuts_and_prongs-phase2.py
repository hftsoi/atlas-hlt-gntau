...
def split_dataset(input_files, output_file,prongs=0 ,tracks_name='tracks', cells_name = 'cells', n_jets_to_get = 50000, n_jets_per_file=int(1e6),sample='Signal'):
    ...
    for jets, tracks, cells in jets_generator(files_in_batches):
        ...
        if prongs == '0':
            ...
            mask3 = abs(jets['TauJets.eta']) < 4.0
            ...
            mask5 = ((jets['TauJets.IsTruthMatched'] == 1) & (abs(jets['TauJets.truthEtaVis']) < 4.0)) | (jets['TauJets.IsHadronicTau'] != 1)
...
gammatautau_dataset = ['/Users/hofungtsoi/Desktop/gntau-train/H5/raw/pu200/Gtautau.h5']
dijet_dataset = [
                 '/Users/hofungtsoi/Desktop/gntau-train/H5/raw/pu200/JZ1.h5',
                 '/Users/hofungtsoi/Desktop/gntau-train/H5/raw/pu200/JZ2.h5',
                 '/Users/hofungtsoi/Desktop/gntau-train/H5/raw/pu200/JZ3.h5',
                 '/Users/hofungtsoi/Desktop/gntau-train/H5/raw/pu200/JZ4.h5',
]
ttbar_dataset = ['/Users/hofungtsoi/Desktop/gntau-train/H5/raw/pu200/ttbar.h5']
...
sample = args.Sample
outpath = {
           'gammatautau':f'/Users/hofungtsoi/Desktop/gntau-train/H5/selection/pu200/{prongs}p/{sample}/gammatautau/',
           'dijet':f'/Users/hofungtsoi/Desktop/gntau-train/H5/selection/pu200/{prongs}p/{sample}/dijet/',
            'ttbar':f'/Users/hofungtsoi/Desktop/gntau-train/H5/selection/pu200/{prongs}p/{sample}/ttbar/',
